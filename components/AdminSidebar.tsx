...
export default function AdminSidebar() {
  ...
  return (
    <aside style={{ width: '220px', minWidth: '220px', background: 'white', borderRight: '2px solid #c8e0d2', display: 'flex', flexDirection: 'column', height: '100vh', position: 'sticky', top: 0, boxShadow: '2px 0 8px rgba(26,107,58,0.07)' }}>
      ...
      <div style={{ background: '#f0f8f3', borderBottom: '1px solid #c8e0d2', padding: '0.4rem 1rem' }}>
        <span style={{ fontSize: '0.62rem', fontWeight: '700', color: '#1a6b3a', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Super Admin Panel</span>
      </div>
